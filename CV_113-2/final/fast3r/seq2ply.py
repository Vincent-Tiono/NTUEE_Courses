...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='Convert RGB-D sequence to PLY point cloud.')
    parser.add_argument('--seq_path', type=str, required=True, help='Path to the input sequence folder')
    parser.add_argument('--output_name', type=str, required=True, help='Output PLY file path')
    args = parser.parse_args()

    seq2ply(args.seq_path, args.output_name, kf_every=1000, voxel_grid_size = 7.5e-3) 