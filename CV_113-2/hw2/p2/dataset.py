...
def get_dataloader(
    ...
    if split == 'train':
        transform = transforms.Compose([
            ...
            # Rotate image randomly within ±15 degree range
            transforms.RandomRotation(degrees=15),
            # Crop image randomly with 4-pixel padding and resize to 32x32
            transforms.RandomCrop(size=(32, 32), padding=4),
            # Adjust image color properties randomly within specified ranges
