...
if __name__ == '__main__':
    ...
    dst = np.zeros((h, w, c))
    output3_1 = warping(secret1, dst, solve_homography(corners1, frame_corners), 0, w, 0, h, direction='b')
    
    dst = np.zeros((h, w, c))
    output3_2 = warping(secret2, dst, solve_homography(corners2, frame_corners), 0, w, 0, h, direction='b')
